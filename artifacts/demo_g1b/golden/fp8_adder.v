...
begin
    ...
    // Special cases: zero, max exponent, cancellation
    if (a[6:0] == 7'd0 && b[6:0] == 7'd0) begin
        y = (a[7] & b[7]) ? 8'b10000000 : 8'b00000000;
    end else if (a[6:0] == 7'd0) begin
        y = b;
    end else if (b[6:0] == 7'd0) begin
        y = a;
    end else if (a[7] != b[7] && a[6:0] == b[6:0]) begin
        y = 8'd0;
    end else if (a[6:0] == 7'b1111111) begin
        y = {a[7], 7'b1111111};
    end else if (b[6:0] == 7'b1111111) begin
        y = {b[7], 7'b1111111};
    end else if (a[6:3] == 4'b1111 && b[6:3] == 4'b1111 && a[2:0] + b[2:0] > 4'd15) begin
        y = {a[7], 7'b1111111};
    end else begin
        // Exponent alignment
        ...
        // Sticky bits - compute in parallel, no priority chain
        ...
        if (found) begin
            if ((a[6:3] != 4'd0) || (b[6:3] != 4'd0)) begin
                ...
                end else if (leading_1_index < 5'd7) begin
