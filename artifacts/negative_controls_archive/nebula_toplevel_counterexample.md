...
3. **FP4 stream:** `fp4_dot_stage` is `PROPERTY_VIOLATED` at depth 16 in 11.4 s under a +4 cycle contract.
...
- `g1c`: `4c2a453f2e1bc3e32803b9f21da69d1bd1a2b3b7cfd8cedeff80a7a575308af5` — `/tmp/nebula_g1c_counterexample.json`
