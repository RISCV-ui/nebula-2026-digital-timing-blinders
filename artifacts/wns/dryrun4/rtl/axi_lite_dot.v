...
// The dot unit and the FIFO control around it now live in fp4_dot_stage.
// Pure hierarchy split: every expression there is what these lines drove.
assign va =  fifo_data_read_1;
assign vb =  fifo_data_read_2;
assign fifo_data_write = dot_out;

fp4_dot_stage dot_stage_0(
    .clk(clk_2), .rst(rst_2),
