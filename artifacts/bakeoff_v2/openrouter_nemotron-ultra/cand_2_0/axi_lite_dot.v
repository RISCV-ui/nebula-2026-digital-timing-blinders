...
/////// peripheral dot 
fp4_dot_unit    fp4_dot_0(clk_2, rst_2, va ,vb , dot_out, dot_valid );
...
// Pipeline w_en to match fp4_dot_unit 3-cycle latency
reg w_en_s1, w_en_s2, w_en_s3;
always @(posedge clk_2) begin
    if (rst_2) begin
        ...
        w_en_s1 <= (!fifo_empty_1 && !fifo_empty_2 && !fifo_full);
        w_en_s2 <= w_en_s1;
        w_en_s3 <= w_en_s2;
    end
end
