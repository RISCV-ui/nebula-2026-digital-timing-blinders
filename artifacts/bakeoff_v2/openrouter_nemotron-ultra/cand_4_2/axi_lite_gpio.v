...
module axi_lite_gpio(clk_1,rst_1, clk_2, rst_2,int_out_gpio,gpio_en,gpio_write, gpio_read, 
  ...
  output int_out_gpio;
  output [31:0] gpio_en,gpio_write;
...
asynchronous_fifo_gen #( .width(41),.logofdepth(4))fifo_timer_w
                         (clk_1,rst_1,
                          clk_2,rst_2,
...
/////// peripheral gpio
gpio_controller   gpio_0(clk_2,rst_2, 
