...
// Pipeline stage 1: register level-1 sums so level-2 adders start
// a fresh combinational stage instead of chaining behind level-1's
// full normalize/round logic.
...
// Pipeline stage 2: register level-2 sums before the final adder.
always @(posedge clk) begin
    add_4_r <= add_4;
    add_5_r <= add_5;
end
