...
// flop and magnitude_reg is a flop, but the square root itself is now
// pipelined 3 cycles deep INSIDE isqrt_restoring_32 (clk forwarded to
// it) so the 267-stage combinational chain that used to sit entirely
// between read_reg and magnitude_reg is broken into four shorter
// sections. magnitude_reg therefore captures the root 3 cycles later
// than it used to; every other register/output timing is unchanged.
