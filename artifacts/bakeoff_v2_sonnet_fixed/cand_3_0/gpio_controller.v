...
// flop and magnitude_reg is a flop; the square root itself is now a
// 3-stage pipeline inside isqrt_restoring_32, so pin_magnitude becomes
// valid 3 clk cycles after read_reg updates instead of combinationally.
