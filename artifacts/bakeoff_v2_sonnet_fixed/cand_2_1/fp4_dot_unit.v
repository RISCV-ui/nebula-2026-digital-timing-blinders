...
// Pipeline registers splitting the 3-level fp8_adder chain
// (level1 -> level2 -> level3) into three separate combinational
// stages. No reset: these hold no architectural state, they only
// stage a feed-forward datapath, matching the module's original
// (unreset) combinational behaviour once the pipe drains.
